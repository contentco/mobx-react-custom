...
import React__default, { Component, forwardRef, memo, createElement } from 'react';
...
function makeClassComponentObserver(componentClass) {
  ...
  if (target.componentWillReact) throw new Error("The componentWillReact life-cycle event is no longer supported"); // if (componentClass["__proto__"] !== PureComponent) {
